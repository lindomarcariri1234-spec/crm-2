 ...
 * never searches or changes data across tenants and is idempotent.
 */

import { db, pool, reservationsTable, tripsTable } from "@workspace/db";
...
async function main(): Promise<void> {
  ...
  const row = candidate as Candidate;
