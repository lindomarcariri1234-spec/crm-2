...
**How to apply:** Preserve the explicit Vite framework selection whenever changing Vercel configuration. Do not switch the whole project to the Express preset unless the deployment architecture is intentionally redesigned.