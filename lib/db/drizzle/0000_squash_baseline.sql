...
CREATE TABLE IF NOT EXISTS "reservations" (
        ...
        "is_gratuidade" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "referral_campaigns" (
        ...
        "eligible_activity_segments" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
CREATE TABLE IF NOT EXISTS "referral_tracking" (
        ...
        "created_at" timestamp with time zone DEFAULT now() NOT NULL,
        "updated_at" timestamp with time zone DEFAULT now() NOT NULL,
        CONSTRAINT "referral_tracking_tenant_cookie_unique" UNIQUE("tenant_id","cookie_id")
);;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "referrals" ADD CONSTRAINT "referrals_reservation_id_fkey"
  FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE set null ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_bonus_reversals" ADD CONSTRAINT "referral_bonus_reversals_tenant_id_fkey"
  FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_bonus_reversals" ADD CONSTRAINT "referral_bonus_reversals_referral_id_fkey"
  FOREIGN KEY ("tenant_id", "referral_id") REFERENCES "public"."referrals"("tenant_id", "id") ON DELETE restrict ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_tracking" ADD CONSTRAINT "referral_tracking_tenant_id_fkey"
  FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_settings" ADD CONSTRAINT "referral_settings_tenant_id_fkey"
  FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_campaigns" ADD CONSTRAINT "referral_campaigns_tenant_id_fkey"
  FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_commissions" ADD CONSTRAINT "referral_commissions_tenant_id_fkey"
  FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_commissions" ADD CONSTRAINT "referral_commissions_referral_id_fkey"
  FOREIGN KEY ("tenant_id", "referral_id") REFERENCES "public"."referrals"("tenant_id", "id") ON DELETE restrict ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referral_attempt_logs" ADD CONSTRAINT "referral_attempt_logs_tenant_id_fkey"
  FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "email_logs" ADD CONSTRAINT "email_logs_referral_id_fkey"
  FOREIGN KEY ("referral_id") REFERENCES "public"."referrals"("id") ON DELETE set null ON UPDATE no action;;
--> statement-breakpoint
ALTER TABLE "referrals" ADD CONSTRAINT "referrals_status_check"
  CHECK ("status" IN ('pending', 'completed', 'converted', 'expired', 'reversed'));;
--> statement-breakpoint
...
ALTER TABLE "referrals" ADD CONSTRAINT "referrals_reversal_consistency_check"
  CHECK ("status" <> 'reversed' OR "reversal_at" IS NOT NULL);;
--> statement-breakpoint
...
ALTER TABLE "referral_commissions" ADD CONSTRAINT "referral_commissions_pending_payment_check"
  CHECK ("status" NOT IN ('pending', 'approved') OR "paid_at" IS NULL);;
--> statement-breakpoint
