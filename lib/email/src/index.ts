...
export { sendAgencySuspendedEmail, sendAgencyReactivatedEmail, sendTrialExpiryEmail } from './service';
export type { AgencySuspendedEmailProps, AgencyReactivatedEmailProps, TrialExpiryEmailProps } from './service';
...
export { TrialExpiryEmail } from './templates/trial-expiry';
