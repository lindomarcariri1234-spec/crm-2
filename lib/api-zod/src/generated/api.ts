...
export const GetDashboardSummaryResponse = zod.object({
  ...
  overduePaymentsCount: zod.number().optional(),
  conversionRate: zod.number().optional(),
  pipelineLeads: zod.number().optional(),
  salesThisMonth: zod.number().optional(),
  retentionRate: zod.number().optional(),
  loyaltyPointsIssued: zod.number().optional(),
  avgNps: zod.number().nullish(),
  tripsThisMonth: zod.number().optional(),
  pendingReservations: zod.number().optional(),
...
export const GetClientReferralResponse = zod.object({
  ...
  referralSuspendedAttemptCount: zod.number().optional(),
  attemptLogs: zod
    .array(
      zod.object({
        id: zod.string(),
...
export const ListNpsResponsesResponseItem = zod.object({
  ...
  clientName: zod.string().nullish(),
  scoreTransport: zod.number().nullish(),
  scoreService: zod.number().nullish(),
  scoreOrganization: zod.number().nullish(),
  scoreGuide: zod.number().nullish(),
  createdAt: zod.string(),
});
