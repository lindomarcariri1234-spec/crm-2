...
export const GetPmsAvailabilityQueryParams = zod.object({
  ...
  checkIn: zod.date(),
  checkOut: zod.date(),
  excludeReservationId: zod.coerce.string().optional(),
});
 ...
 */
export const UpdatePmsReservationParams = zod.object({
  id: zod.coerce.string(),
});

export const updatePmsReservationBodyChildrenMin = 0;

export const updatePmsReservationBodyInfantsMin = 0;

export const updatePmsReservationBodyItemsItemAdultsDefault = 1;

export const updatePmsReservationBodyItemsItemChildrenDefault = 0;
export const updatePmsReservationBodyItemsItemChildrenMin = 0;

export const updatePmsReservationBodyItemsItemUnitPriceMin = 0;

export const updatePmsReservationBodyGuestsItemGuestTypeDefault = `ADULT`;
export const updatePmsReservationBodyGuestsItemItemIndexMin = 0;

export const UpdatePmsReservationBody = zod.object({
  ...
  children: zod
    .number()
    .int()
    .min(updatePmsReservationBodyChildrenMin)
    .optional(),
  infants: zod
    .number()
    .int()
    .min(updatePmsReservationBodyInfantsMin)
    .optional(),
  notes: zod.string().nullish(),
  items: zod
    .array(
      zod.object({
        ...
        adults: zod
          ...
          .int()
          .min(1)
          .default(updatePmsReservationBodyItemsItemAdultsDefault),
        children: zod
          .number()
          .int()
          .min(updatePmsReservationBodyItemsItemChildrenMin)
          .default(updatePmsReservationBodyItemsItemChildrenDefault),
        unitPrice: zod
          .number()
          .min(updatePmsReservationBodyItemsItemUnitPriceMin)
          .optional(),
        ratePlanId: zod.string().nullish(),
      }),
    )
  ...
  guests: zod
    .array(
      zod.object({
        ...
        guestType: zod
          .enum(["ADULT", "CHILD", "INFANT"])
          .default(updatePmsReservationBodyGuestsItemGuestTypeDefault),
        itemIndex: zod
          .number()
          .int()
          .min(updatePmsReservationBodyGuestsItemItemIndexMin)
          .optional(),
      }),
    )
    .optional(),
...
export const UpdatePmsReservationResponse = zod.object({
  reservation: zod.object({
    id: zod.string(),
    tenantId: zod.string(),
    propertyId: zod.string(),
 ...
 */
export const CancelPmsReservationParams = zod.object({
  id: zod.coerce.string(),
});

export const cancelPmsReservationBodyReasonMin = 3;
export const cancelPmsReservationBodyReasonMax = 500;

export const CancelPmsReservationBody = zod.object({
  reason: zod
    .string()
    .min(cancelPmsReservationBodyReasonMin)
    .max(cancelPmsReservationBodyReasonMax),
});

export const CancelPmsReservationResponse = zod.object({
  reservation: zod.object({
    id: zod.string(),
    tenantId: zod.string(),
    propertyId: zod.string(),
 ...
 */
export const GetReservationRoomAssignmentsParams = zod.object({
 ...
 */
export const UpdateReservationRoomAssignmentsParams = zod.object({
  reservationId: zod.coerce.string(),
});

export const UpdateReservationRoomAssignmentsBody = zod.object({
  assignments: zod.array(
    zod.object({
      passengerId: zod.string(),
 ...
 */
export const ListAccommodationRoomsParams = zod.object({
  id: zod.coerce.string(),
});

export const ListAccommodationRoomsResponseItem = zod.object({
  id: zod.string(),
  tenantId: zod.string(),
  accommodationId: zod.string(),
  name: zod.string(),
...
export const ListAccommodationRoomsResponse = zod.array(
  ListAccommodationRoomsResponseItem,
);

/**
 * @summary Create a room
 */
export const CreateAccommodationRoomParams = zod.object({
  id: zod.coerce.string(),
});
 ...
 */
export const UpdateAccommodationRoomParams = zod.object({
  id: zod.coerce.string(),
});
 ...
 */
export const DeleteAccommodationRoomParams = zod.object({
  id: zod.coerce.string(),
});

export const DeleteAccommodationRoomResponse = zod.object({
  success: zod.boolean(),
});
 ...
 */
export const UpdateTripAccommodationParams = zod.object({
  id: zod.coerce.string(),
});

export const UpdateTripAccommodationBody = zod.object({
  accommodationId: zod.string().nullable(),
});

export const updateTripAccommodationResponseFreeOrganizersMin = 0;
export const updateTripAccommodationResponseFreeOrganizersMax = 2;

export const updateTripAccommodationResponseFreeGuidesMin = 0;
export const updateTripAccommodationResponseFreeGuidesMax = 2;

export const UpdateTripAccommodationResponse = zod.object({
  id: zod.string(),
  name: zod.string(),
  slug: zod.string(),
  description: zod.string().nullish(),
  ...
  freeOrganizers: zod
    .number()
    .int()
    .min(updateTripAccommodationResponseFreeOrganizersMin)
    .max(updateTripAccommodationResponseFreeOrganizersMax)
    .nullish(),
  freeGuides: zod
    .number()
    .int()
    .min(updateTripAccommodationResponseFreeGuidesMin)
    .max(updateTripAccommodationResponseFreeGuidesMax)
    .nullish(),
  freePassengers: zod
    .array(
      zod.object({
